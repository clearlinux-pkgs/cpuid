...
Version  : 20201006
Release  : 19
URL      : http://www.etallen.com/cpuid/cpuid-20201006.src.tar.gz
Source0  : http://www.etallen.com/cpuid/cpuid-20201006.src.tar.gz
...
%prep
%setup -q -n cpuid-20201006
cd %{_builddir}/cpuid-20201006
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601997908
...
cp %{_builddir}/cpuid-20201006/LICENSE %{buildroot}/usr/share/package-licenses/cpuid/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
