...
Version  : 20211210
Release  : 24
URL      : http://www.etallen.com/cpuid/cpuid-20211210.src.tar.gz
Source0  : http://www.etallen.com/cpuid/cpuid-20211210.src.tar.gz
...
%prep
%setup -q -n cpuid-20211210
cd %{_builddir}/cpuid-20211210
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639413995
...
cp %{_builddir}/cpuid-20211210/LICENSE %{buildroot}/usr/share/package-licenses/cpuid/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
