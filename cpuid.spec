...
Version  : 20240916
Release  : 46
URL      : https://www.etallen.com/cpuid/cpuid-20240916.src.tar.gz
Source0  : https://www.etallen.com/cpuid/cpuid-20240916.src.tar.gz
...
%prep
%setup -q -n cpuid-20240916
cd %{_builddir}/cpuid-20240916
pushd ..
cp -a cpuid-20240916 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726521852
