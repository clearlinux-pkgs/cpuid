...
Source0  : http://www.etallen.com/cpuid/cpuid-20211129.src.tar.gz
...
%prep
%setup -q -n cpuid-20211129
cd %{_builddir}/cpuid-20211129
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638362023
...
cp %{_builddir}/cpuid-20211129/LICENSE %{buildroot}/usr/share/package-licenses/cpuid/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
