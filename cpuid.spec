...
Version  : 20200120
Release  : 13
URL      : http://www.etallen.com/cpuid/cpuid-20200120.src.tar.gz
Source0  : http://www.etallen.com/cpuid/cpuid-20200120.src.tar.gz
...
%prep
%setup -q -n cpuid-20200120
cd %{_builddir}/cpuid-20200120
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579624234
...
cp %{_builddir}/cpuid-20200120/LICENSE %{buildroot}/usr/share/package-licenses/cpuid/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
