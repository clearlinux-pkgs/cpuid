...
Version  : 20211121
Release  : 22
URL      : http://www.etallen.com/cpuid/cpuid-20211121.src.tar.gz
Source0  : http://www.etallen.com/cpuid/cpuid-20211121.src.tar.gz
...
%prep
%setup -q -n cpuid-20211121
cd %{_builddir}/cpuid-20211121
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637599419
...
cp %{_builddir}/cpuid-20211121/LICENSE %{buildroot}/usr/share/package-licenses/cpuid/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
