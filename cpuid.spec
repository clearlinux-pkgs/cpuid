...
Version  : 20200112
Release  : 11
URL      : http://www.etallen.com/cpuid/cpuid-20200112.src.tar.gz
Source0  : http://www.etallen.com/cpuid/cpuid-20200112.src.tar.gz
...
%prep
%setup -q -n cpuid-20200112
cd %{_builddir}/cpuid-20200112
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579019758
...
cp %{_builddir}/cpuid-20200112/LICENSE %{buildroot}/usr/share/package-licenses/cpuid/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
