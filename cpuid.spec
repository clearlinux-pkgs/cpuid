...
Source0  : http://www.etallen.com/cpuid/cpuid-20200127.src.tar.gz
...
%prep
%setup -q -n cpuid-20200127
cd %{_builddir}/cpuid-20200127
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1580226193
...
cp %{_builddir}/cpuid-20200127/LICENSE %{buildroot}/usr/share/package-licenses/cpuid/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
