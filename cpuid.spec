...
Version  : 20240716
Release  : 43
URL      : https://www.etallen.com/cpuid/cpuid-20240716.src.tar.gz
Source0  : https://www.etallen.com/cpuid/cpuid-20240716.src.tar.gz
...
%prep
%setup -q -n cpuid-20240716
cd %{_builddir}/cpuid-20240716
pushd ..
cp -a cpuid-20240716 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721139408
