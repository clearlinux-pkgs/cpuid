...
Source0  : https://www.etallen.com/cpuid/cpuid-20250316.src.tar.gz
...
%prep
%setup -q -n cpuid-20250316
cd %{_builddir}/cpuid-20250316
pushd ..
cp -a cpuid-20250316 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742830178
