...
Source0  : https://www.etallen.com/cpuid/cpuid-20240709.src.tar.gz
...
%prep
%setup -q -n cpuid-20240709
cd %{_builddir}/cpuid-20240709
pushd ..
cp -a cpuid-20240709 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720534971
