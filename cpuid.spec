...
Source0  : https://www.etallen.com/cpuid/cpuid-20240324.src.tar.gz
...
%prep
%setup -q -n cpuid-20240324
cd %{_builddir}/cpuid-20240324
pushd ..
cp -a cpuid-20240324 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711311401
