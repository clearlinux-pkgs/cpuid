...
Version  : 20250419
Release  : 50
URL      : https://www.etallen.com/cpuid/cpuid-20250419.src.tar.gz
Source0  : https://www.etallen.com/cpuid/cpuid-20250419.src.tar.gz
...
%prep
%setup -q -n cpuid-20250419
cd %{_builddir}/cpuid-20250419
pushd ..
cp -a cpuid-20250419 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745245880
